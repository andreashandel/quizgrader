...
* `/complete_quizzes` - a folder which will contain all your quizzes (with answers) once you made them. 
...
If at any point you need a clean version of the templates, you can get them through the user interface (or find them in the `/templates` folder of the R package).
...
Add it to the system by clicking the `Add studentlist` button in the UI or manually place it into the `/studentlist` folder and rename/save it as `studentlist_filled.xlsx`. 
This new name is required and prevents accidental overwriting if you re-generate the templates. 
